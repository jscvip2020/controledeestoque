                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($data as $user)
                                            <tr>
                                                ...
                                                <td class="action">
                                                    <a class="btn btn-info" href="{{ route('users.edit', $user->id) }}" title="Editar"><i class="fa fa-edit"></i></a>
                                                    <form id="form-delete{{$user->id}}" action="{{ route('users.destroy', $user->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button"
